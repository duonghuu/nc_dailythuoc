<div id="valak_mmenu">
  <div class="logomini-box">
    <div class="logomini_valak"><a href=""><strong>MENU</strong><?php /* <img src="<?= _upload_hinhanh_l.$logolang["photo"] ?>" alt="logo"> */?></a></div>
  ...
  <a href="" class="valak-home"><i class="fas fa-home"></i></a>
   <a class="valak-phone" href="tel:<?=preg_replace('/[^0-9]/','',$company['dienthoai']);?>"><i class="fas fa-phone-alt"></i> <?= $company["dienthoai"] ?></a> 
  </div>*/?>
  <?php /* <div id="valak_lang"> <a href="index.php?com=ngonngu&lang=en" title="English"><img src="images/en.png" alt="English" /> </a> <a href="index.php?com=ngonngu&lang=" title="Việt Nam"><img src="images/vi.png" alt="Việt Nam" /></a> </div><!--END #lang--> */?>
  <?php /* 
      
        <?php if($deviceType!="computer"){ ?>
        <a href="gio-hang.html" class="giohang_fix"><span><?= count($_SESSION["cart"]) ?></span></a>
      <?php } ?> */?>
 <div class="valak-search"> <input type="text" id="txtCountry2" class="form-control keyword placeholder-1" required="true" value="<?=_nhaptukhoatimkiem?>..." onclick="if(this.value=='<?=_nhaptukhoatimkiem?>...'){this.value=''}" onblur="if(this.value==''){this.value='<?=_nhaptukhoatimkiem?>...'}"> <span onclick="onSearch($(this));return false;" class="btn_search"><i class="fas fa-search"></i></span> </div>
</div>
<div id="valak_openmmenu">
  <div id="valak_main">
    <div id="close_valak"></div>
    <div class="scroll_menu_valak">
      <div class="logo_valak">MENU<?php /* <img src="<?= _upload_hinhanh_l.$logolang["photo"] ?>" alt="logo"> */?></div>
