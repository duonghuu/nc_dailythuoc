        ...
        <div class="trangchu-flex">
            <div class="spnoibat-bg">
                ...
                <div class="product-grid">
                    <?php
                    // for($i=0;$i< 8 ;$i++) 
                    // echo '<div class="pr-box name "><article><a href="'.$link.'" class="imgsp"><img src="https://placehold.it/280x260/ed555a?text=." alt="'.$v["ten"].'">'.$cls_banchay.$giaspgiam.'</a> <div class="info"><h3><a href="'.$link.'">Sản phẩm nổi bật</a></h3><div class="boxmota"><div class="promasp">Mã sp: '._masp.'</div><p>Giá: '._lienhe.'</p></div></div></article></div>';
