<div class="job-detail-head">
    ...
    <div class="job-detail-img"><figure><img src="<?= _upload_tintuc_l.$row_detail["photo"] ?>" alt="<?= $row_detail["ten"] ?>"></figure></div>
...
<div class="job-detail-body">
    ...
    <div class="job-detail-right">
                <div class="job-detail-form training-apply-form">
                    <ul>
                      <li class="active"><a data-toggle="pill" href="#cs-tab-already-registered-apply5765">Apply</a></li>
                      <li ><a data-toggle="pill" href="#cs-tab-register9640">Register</a></li>
                    </ul>
