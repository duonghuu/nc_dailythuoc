...
<?
    $file='https://vnexpress.net/rss/tin-moi-nhat.rss';
    switch($_REQUEST['mod'])
    {
	case "tin-moi-nhat":
    $file='https://vnexpress.net/rss/tin-moi-nhat.rss';
    break;
	case "thoi-su":
    $file='https://vnexpress.net/rss/thoi-su.rss';
    break;
    case "the-gioi":
    $file='https://vnexpress.net/rss/the-gioi.rss';
    break;
    case "kinh-doanh":
    $file='https://kinhdoanh.vnexpress.net/rss/doanh-nghiep.rss';
    break;
    case 'phap-luat':
    $file='https://vnexpress.net/rss/phap-luat.rss';
    break;
    case 'khoa-hoc':
    $file="https://vnexpress.net/rss/khoa-hoc.rss";
    break;
    case 'oto-xe-may':
    $file='https://vnexpress.net/rss/oto-xe-may.rss';
    break;
	case 'cong-dong':
    $file='https://vnexpress.net/rss/cong-dong.rss';
    break;
	case 'tam-su':
    $file='https://vnexpress.net/rss/tam-su.rss';
    break;
	case 'cuoi':
    $file='https://vnexpress.net/rss/cuoi.rss';
    break;
    default:
    $file='https://kinhdoanh.vnexpress.net/rss/doanh-nghiep.rss';
    break;
  ...
  <tr>
    ...
    <a href="<? echo $link->nodeValue ;?>" style="text-decoration:none;" target="_blank" />
		...
		<?php
			...
			$img_search= "/Files";
			$img_show="https://vnexpress.net/Files";
