...
<form name="supplier" id="validate" class="form" action="index.php?com=company&act=save" method="post" enctype="multipart/form-data">
  <div class="widget">
    ...
    <div class="formRow ">
      <label>Slogan</label>
      <div class="formRight">
        <input type="text" value="<?php echo htmlentities(@$item['slogan'.$key], ENT_QUOTES);?>" name="slogan<?=$key?>" title="Nhập Slogan" class="tipS" />
      </div>
      <div class="clear"></div>
    </div>
    </div>
...
<?php } ?>
    ...
    <div class="formRow">
      ...
      <div class="formRight">
        <textarea rows="8" cols="" class="tipS description_input" name="codethem" original-title="Nhập thêm các code muốn thêm vào website như google analytics..."><?=@$item['codethem']?></textarea>
      </div>
      <div class="clear"></div>
    </div>
         <div class="formRow">
      <label>Code thêm body - chat</label>
      <div class="formRight">
...
<?php /* <script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyACyJA0Ifi-Y2FmzHOrZYNMY5q4-qATAUg&sensor=false&libraries=places"></script> */?>
<script type="text/javascript">
