 ...
 <div class="widget">
    ...
    <?php if(in_array('maunen',$config['type'])) { ?>
      <div class="formRow">
        <label>Màu nền</label>
        <div class="formRight">
          <input type="text" name="maunen" title="Màu nền" id="maunen" class="input short_input cp3" value="<?=@$item['maunen']?>" />
        </div>
        <div class="clear"></div>
      </div>
    <?php } ?>
        ...
        <div id="content_lang_<?=$key?>" class="tab_content">
           ...
           <?php if(in_array('noidung',$config['type'])) { ?>
             <div class="formRow ">
               ...
               <div class="formRight">
                 <textarea rows="8" cols="" title="Viết nội dung bài viết" class="tipS ck_editor" name="noidung<?=$key?>" id="noidung<?=$key?>"><?=@$item['noidung'.$key]?></textarea>
               </div>
               <div class="clear"></div>
             </div>
           <?php } ?>
