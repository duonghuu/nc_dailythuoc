	...
	<form name="supplier" id="validate" class="form" action="index.php?com=pushOnesignal&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
		<div class="widget">
		      ...
		      <div class="formRow lang_hidden lang_vi active">
		        ...
		        <div class="formRight">
		          <input type="text" name="link" title="Nhập tên danh mục" id="link" class="tipS" value="<?=@$item['link']?>" placeholder="https://youlink.com"/>
		        </div>
		        <div class="clear"></div>
		      </div>
		<!--      <div class="formRow lang_hidden lang_vi active">
		    ...
		    <div class="widget">
		      ...
		      <div class="formRow lang_hidden lang_vi active">
		        ...
		        <div class="formRight">
		          ...
		          <?php /*?> <input type="text" name="link" title="Nhập tên danh mục" id="link" class="tipS" value="<?=@$item['link']?>" placeholder="https://youlink.com"/> <?php */?>
		        </div>
		        <div class="clear"></div>
		      </div>
