     ...
     <?php foreach ($config['lang'] as $key => $value) { ?>
         ...
         <?php if(in_array('chucvu',$config['type'])) { ?>
           <div class="formRow">
             ...
             <div class="formRight">
               <input type="text" name="chucvu<?=$key?>" title="Nhập nội dung" id="chucvu<?=$key?>" class="tipS" value="<?=@$item['chucvu'.$key]?>" />
             </div>
             <div class="clear"></div>
           </div>
         <?php } ?>
         <?php if(in_array('link',$config['type'])) { ?>
           <div class="formRow">
             ...
             <div class="formRight">
               <input type="text" name="link<?=$key?>" title="Nhập nội dung" id="link<?=$key?>" class="tipS" value="<?=@$item['link'.$key]?>" />
             </div>
             <div class="clear"></div>
           </div>
         <?php } ?>
         ...
         <?php if(in_array('vitri',$config['type'])) { ?>
           <div class="formRow">
             ...
             <div class="formRight"><textarea class="ck_editor" name="vitri<?=$key?>" id="vitri<?=$key?>" rows="8" cols="60"><?=@$item['vitri'.$key]?></textarea>
             </div>
             <div class="clear"></div>
           </div>
         <?php } ?>
         ...
         <?php if(in_array('tienich',$config['type'])) { ?>
           <div class="formRow">
             ...
             <div class="formRight"><textarea class="ck_editor" name="tienich<?=$key?>" id="tienich<?=$key?>" rows="8" cols="60"><?=@$item['tienich'.$key]?></textarea>
             </div>
             <div class="clear"></div>
           </div>
         <?php } ?>
         <?php if(in_array('matbang',$config['type'])) { ?>
           <div class="formRow">
             ...
             <div class="formRight"><textarea class="ck_editor" name="matbang<?=$key?>" id="matbang<?=$key?>" rows="8" cols="60"><?=@$item['matbang'.$key]?></textarea>
             </div>
             <div class="clear"></div>
           </div>
         <?php } ?>
         <?php if(in_array('hinhanhvi',$config['type'])) { ?>
           <div class="formRow">
             ...
             <div class="formRight"><textarea class="ck_editor" name="hinhanh<?=$key?>" id="hinhanh<?=$key?>" rows="8" cols="60"><?=@$item['hinhanh'.$key]?></textarea>
             </div>
             <div class="clear"></div>
           </div>
         <?php } ?>
