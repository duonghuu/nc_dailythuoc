...
<div class="widget">
	...
	<div class="formRow none">
		...
		<div class="formRow">
			...
			<div class="formRight">
	        	<input type="text" name="quoctich" id="quoctich" value="<?=$item['quoctich']?>" class="input" />
			</div>
			<div class="clear"></div>
		</div>
	<div class="formRow">
	...
	<div class="formRow">
		...
		<div class="formRight">
        	<input type="text" name="didong" value="<?=$item['didong']?>" class="input" />
		</div>
		<div class="clear"></div>
	</div>
		<div class="formRow">
			...
			<div class="formRight">
	        	<input type="text" name="curjob" value="<?=$item['curjob']?>" class="input" />
			</div>
			<div class="clear"></div>
		</div>
	<div class="formRow none">
