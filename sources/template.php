...
$product_danhmuc=get_result("select ten$lang as ten,tenkhongdau,id,type,thumb,photo from #_product_danhmuc where type='sanpham' and hienthi=1 order by stt asc");
